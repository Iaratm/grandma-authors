...
{'name': 'M.~Bo\\"er', 'affiliations': ["Artemis, Observatoire de la C\\^ote d'Azur, Universit\\'e C\\^ote d'Azur, Boulevard de l'Observatoire, 06304 Nice, France"], 'email': 'michel.boer@oca.eu'},
{'name': 'E.~Broens', 'affiliations': ["Vereniging Voor Sterrenkunde, Balen-Neetlaan 18A, 2400, Mol, Belgium"], 'email': ''},
...
{'name': 'M.~Bulla', 'affiliations': ['Department of Physics and Earth Science, University of Ferrara, via Saragat 1, I-44122 Ferrara, Italy', 'INFN, Sezione di Ferrara, via Saragat 1, I-44122 Ferrara, Italy', 'INAF, Osservatorio Astronomico d’Abruzzo, via Mentore Maggini snc, I-64100 Teramo, Italy'], 'email': 'mattia.bulla@unife.it'}, 
{'name': 'O.~Burkhonov', 'affiliations': ['Ulugh Beg Astronomical Institute, Uzbekistan Academy of Sciences, Astronomy Str. 33, Tashkent 100052, Uzbekistan'], 'email': ''},
...
#{'name': 'F.~Colas', 'affiliations': ["Astronomie et Syst\\`emes Dynamiques, Institut de M\\'ecanique C\\'eleste et de Calcul des \\'Eph\\'em\\'erides CNRS UMR 8028, Observatoire de Paris, Universit\\'e PSL, Sorbonne Universit\\'e, 77 Avenue Denfert-Rochereau, 75014 Paris, France"], 'email': 'francois.colas@obspm.fr'},à
...
{'name': 'H.~A.~R.~Devillepoix', 'affiliations': ["Space Science \\& Technology Centre, School of Earth and Planetary Sciences, Curtin University, GPO Box U1987, Perth, Western Australia 6845, Australia"], 'email': ''},
...
{'name': 'D.~Froebrich', 'affiliations': ["School of Physics and Astronomy, University of Kent, Canterbury CT2 7NH, UK"], 'email': ''},
...
{'name': 'D.~A.~Kann', 'affiliations': ["Hessian Research Cluster ELEMENTS, Giersch Science Center, Max-von-Laue-Stra{\\ss}e 12, Goethe University Frankfurt, Campus Riedberg, 60438 Frankfurt am Main, Germany"], 'email': 'ultralonggrbsn@gmail.com'},
...
{'name': 'F.~D.~Romanov', 'affiliations': ["AAVSO observer; Pobedy street, house 7, flat 60, Yuzhno-Morskoy, Nakhodka, Primorsky Krai 692954, Russia"], 'email': ''},
...
{'name': 'A.~Shokry', 'affiliations': ["National Research Institute of Astronomy and Geophysics (NRIAG), 1 El-marsad St., 11421 Helwan, Cairo, Egypt"], 'email': ''},
